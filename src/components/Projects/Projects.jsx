    ...
    <section id="projects" className="projects">
      ...
      <div className="project-card">
        <div className="project-gallery">
          <a
            href="/images/marketpulse-architecture.svg"
            target="_blank"
            rel="noreferrer"
          >
            <img
              className="hero-image"
              src="/images/marketpulse-architecture.svg"
              alt="MarketPulse backend architecture diagram"
            />
          </a>
        </div>
        ...
        <div className="project-info">
          ...
          <p>
            A backend-focused real-time market data platform designed to
            demonstrate production-style API architecture, asynchronous
            processing, caching, persistent market history, and live
            WebSocket updates.
          </p>
          ...
          <ul className="feature-list">
            <li>REST API with validation, authentication and rate limiting</li>
            <li>Redis caching and pub/sub for low-latency market data</li>
            <li>WebSocket subscriptions for live price updates</li>
            <li>BullMQ background processing for asynchronous persistence</li>
            <li>PostgreSQL price history with indexed queries and pagination</li>
            <li>Dockerized local infrastructure and automated CI checks</li>
          </ul>

          <div className="project-buttons">
            <a
              href="https://marketpulse-kozq.onrender.com"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://marketpulse-kozq.onrender.com/docs/"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://github.com/jaiy3/marketpulse"
              target="_blank"
              rel="noreferrer"
              className="secondary-btn"
            >
      ...
      <div className="project-card">
        ...
        <div className="project-info">
          ...
          <div className="project-buttons">
            <a
              href="https://atlas-ai-ashy-six.vercel.app/demo"
              target="_blank"
              rel="noreferrer"
              className="primary-btn"
            >
